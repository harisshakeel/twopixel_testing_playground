...
const TIER_CONFIG = {
  // Pipeline output tiers (lowercase)
  strong: { label: 'STRONG', bg: 'bg-red-500/15',    text: 'text-red-400',    border: 'border-red-500/30',    dot: 'bg-red-400' },
  normal: { label: 'NORMAL', bg: 'bg-amber-500/15',   text: 'text-amber-400',  border: 'border-amber-500/30',  dot: 'bg-amber-400' },
  weak:   { label: 'WEAK',   bg: 'bg-purple-500/10',  text: 'text-purple-300', border: 'border-purple-500/25', dot: 'bg-purple-300' },
  low:    { label: 'LOW',    bg: 'bg-zinc-700/30',    text: 'text-zinc-500',   border: 'border-zinc-700/40',   dot: 'bg-zinc-600' },
  // Legacy uppercase tiers
